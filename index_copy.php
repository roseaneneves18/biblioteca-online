...
<body class="body1">
        ...
        <div class="header-2">
            <div class="menu">
                <ul>
                    ...
                    <li>
                        <a href="./pag/servicos.html">Serviços</a>
                    </li>
                    <li>
                        <a href="./pag/paginas.html">Páginas</a>
                    </li>
                    <li>
            ...
            <body class="body3">
                ...
                <h2 class="h2Text">"Bem vindo a Bliblioteca Central FADBA"</h2>
                 ...
                 <h1 class="h1Text" >Um Novo Sistema Atualizado Que busca Comprir De Uma Forma Mais Elegante Suas Atividades.</h1>
                            ...
                            <p class="pText">Sistema totalmente moderno com um designer incrível que vai te levar a um pensamento mais amplo do mundo real Lorem ipsum dolor sit amet consectetur adipisicing elit. Sit blanditiis. </p>
                <script>
    ...
    <body class="anuncio">
        ...
        <section class="grid2">
          <div class="video">
            <img src="./img anúncios/AMENINAQUE site .jpg">
          ...
          <div class="sidebar">
            <div>
              <img src="./img anúncios/stardust site.jpg">
              <p class="legenda">Legenda</p>
            </div>
            <div>
              <img src="./img anúncios/O_APANHADOR site.jpg">
              <p class="legenda">Legenda</p>
            </div>
            <div>
              <img src="./img anúncios/O_APANHADOR site.jpg">
